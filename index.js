...
// defined(): the first argument that is not undefined. Replicates the
// option-defaulting that acorn-node used to supply, so we can call acorn
// directly and drop the abandoned acorn-node transitive.
function defined () {
